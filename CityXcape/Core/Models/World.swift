...
extension World {
    ...
    static let data: [String: Any] = [
        ...
        World.CodingKeys.memberName.rawValue: "is a techy",
    ]
    ...
    static let data2: [String: Any] = [
        ...
        World.CodingKeys.memberName.rawValue: "is a scout",
    ...
    static let data3: [String: Any] = [
        ...
        World.CodingKeys.memberName.rawValue: "is a Navy Vet",
    ...
    static let data4: [String: Any] = [
        ...
        World.CodingKeys.memberName.rawValue: "is artsy",
    ]
    ...
    static let data5: [String: Any] = [
        ...
        World.CodingKeys.memberName.rawValue: "is gothic",
