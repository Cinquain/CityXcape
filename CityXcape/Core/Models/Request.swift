...
struct Request: Identifiable, Codable, Equatable {
    ...
    static let demo = Request(id: "abc123", username: "Allison", imageUrl: "https://firebasestorage.googleapis.com/v0/b/cityxcape-8888.appspot.com/o/Users%2FybA5qTaUH3OIMj1qPFACBRzbPnb2%2FAllison.png?alt=media&token=23e6eceb-b9b2-4a49-8b23-a11de0e2d32c", content: "Hello handsome, want to buy me a drink", spotId: "abfhgitiejf", spotName: "Graffiti Pier", worlds: [World.demo3, World.demo, World.demo5])
    
    static let demo2 = Request(id: "abc1dldkkfn23", username: "Ciara", imageUrl: "https://firebasestorage.googleapis.com/v0/b/cityxcape-8888.appspot.com/o/Users%2FybA5qTaUH3OIMj1qPFACBRzbPnb2%2FCiara%20copy.png?alt=media&token=1a10681a-139a-4be7-9ab5-a71ef907bf10", content: "Come to my table", spotId: "abfuygugghgitiejf", spotName: "Parlour Bar", worlds: [World.demo4, World.demo5, World.demo6])
    
    static let demo3 = Request(id: "abc1dlduwuhdhsdhjhdskkfn23", username: "Adam", imageUrl: "https://firebasestorage.googleapis.com/v0/b/cityxcape-8888.appspot.com/o/Users%2FybA5qTaUH3OIMj1qPFACBRzbPnb2%2Fman.png?alt=media&token=7b2a24de-49ce-4d40-a9a6-26325ee45371", content: "Where the weed @", spotId: "abfiuguuygugghgitiejf", spotName: "Hope Breakfast Bar", worlds: [World.demo, World.demo2, World.demo3])
    
    static let demo4 = Request(id: "dfijhfhghgkjgk3", username: "Larelle", imageUrl: "https://firebasestorage.googleapis.com/v0/b/cityxcape-8888.appspot.com/o/Users%2F0t3mrKkN9Iaq0GiZJoTAHXgSNiq1%2Fblack%20girl.png?alt=media&token=ef9bc123-7bd1-4f1b-b9c7-e74d93ffeb2f", content: "Bring your friends to my table", spotId: "abfiuguuygugghgitiejf", spotName: "Four Seasons", worlds: [World.demo3, World.demo, World.demo2])
    
    
    static let demo5 = Request(id: "73747498584", username: "Amanda", imageUrl: "https://firebasestorage.googleapis.com/v0/b/cityxcape-8888.appspot.com/o/Users%2F0t3mrKkN9Iaq0GiZJoTAHXgSNiq1%2FAmanda.png?alt=media&token=05909851-ebf9-47da-9c5a-5ea0670ed28a", content: "Let's get a drink", spotId: "abfiuguuygugghgitiejf", spotName: "Hope Breakfast Bar", worlds: [World.demo4, World.demo2, World.demo6])
    
    static let demo6 = Request(id: "abcdgguf1dlduwuhddhfhiuhfhsdhjhdskkfn23", username: "Sean", imageUrl: "https://firebasestorage.googleapis.com/v0/b/cityxcape-8888.appspot.com/o/Users%2FVAtXB9NvanVNjDN1rZoSTVWbd8G3%2FprofileImage?alt=media&token=1c928ade-f313-4da1-bbd7-90e645441ddb", content: "Let's split the price of a bottle", spotId: "abfiuguuygihsdihfugghgitiejf", spotName: "Devil's Advocate", worlds: [World.demo6, World.demo5, World.demo])
